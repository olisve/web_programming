...
public class Airline {
    ...
    public Airline(){
        this.name = "default";
        this.airplanes = new CopyOnWriteArrayList<Airplane>();
    }
     ...
     */
    public Airplane findAirplaneByType(int type){
        if (type == 1){
     ...
     * @return founded airplane
     */
    public Airplane findAirplaneByRange(int from, int to){
        return  this.airplanes.stream()
     ...
     * @return founded airplane
     */
    public Airplane findAirplaneByCapacity(int from, int to){
        return  this.airplanes.stream()
     ...
     * @return founded airplane
     */
    public Airplane findAirplaneByVolumeOfCargo(int from, int to){
        return  this.airplanes.stream()
                .filter(x -> "CargoAirplane".equals(x.getType()) &&
     ...
     * @return founded airplane
     */
    public Airplane findAirplaneByNumberOfPassengers(int from, int to){
        return  this.airplanes.stream()
                .filter(x -> "PassengerAirplane".equals(x.getType()) &&
     ...
     * @return founded airplane
     */
    public Airplane findAirplaneByAmountOfLuggage(int from, int to){
        return  this.airplanes.stream()
                .filter(x -> "PassengerAirplane".equals(x.getType()) &&
